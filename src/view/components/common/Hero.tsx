...
const Hero = () => {
  ...
  const { movies, getPopularMovies } = useApiStore()
    ...
    <div className="relative ">
      <div className="absolute bottom-0 p-10 md:p-20  bg-gradient-to-t from-[#1e2126] via-transparent w-full">
        ...
        <div className="flex gap-4 mt-3">
          <button className="bg-[#1A1A1A] py-1 px-3 rounded-lg text-lg uppercase font-semibold">Play</button>
          <button className="box-border py-1 px-3 rounded-lg text-lg uppercase font-semibold border-white border-2">Details</button>
        </div>
      </div>
